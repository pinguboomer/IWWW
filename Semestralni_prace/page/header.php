...
<a href="index.php?page=orders&user='. $_SESSION["logged_user"]["id_user"].'">
<img src="/img/orders_icon.png" height="60px" width="60px">';
                if($_SESSION["logged_user"]["role"] == 2){
                    echo '<h3 class="logheader">Objednávky</h3></a></div>';
                } else {
                   echo'<h3 class="logheader">Moje objednávky</h3></a></div>';
                }
                echo'<div class="log" style="margin-left: 30px">
